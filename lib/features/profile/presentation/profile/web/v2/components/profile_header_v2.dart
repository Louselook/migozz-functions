  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // Imagen de perfil circular más pequeña para v2
        _ProfileImageV2(
          avatarUrl: avatarUrl,
...
class _ProfileImageV2 extends StatelessWidget {
  final String? avatarUrl;
  final double screenWidth;
  final bool isSmallScreen;

  const _ProfileImageV2({
    this.avatarUrl,
  ...
  @override
  Widget build(BuildContext context) {
    // Tamaño más grande y responsive para la versión 2
    ...
    final String fallbackAsset = 'assets/images/avatar.webp';
