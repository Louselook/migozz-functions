...
class MobileProfileContentV2 extends StatefulWidget {
  ...
  @override
  State<MobileProfileContentV2> createState() => _MobileProfileContentV2State();
}
          ...
          SafeArea(
            child: CustomScrollView(
              ...
              slivers: [
                ...
                // Barras de redes sociales
                if (socialLinks.isNotEmpty)
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: 10),
                      child: SocialBarsMobileV2(links: socialLinks),
                    ),
                  ),
