...
class ProfileHeaderMobileV3 extends StatelessWidget {
  final String name;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        _ProfileImageMobileV3(avatarUrl: avatarUrl, size: size),
...
class _ProfileImageMobileV3 extends StatelessWidget {
  final String? avatarUrl;
  final Size size;

  const _ProfileImageMobileV3({this.avatarUrl, required this.size});

  @override
  Widget build(BuildContext context) {
    final imageSize = size.width * 0.35;
